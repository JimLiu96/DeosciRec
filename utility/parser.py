...
def parse_args():
    ...
    parser.add_argument('--residual', type=str, default='cross', help='the residual module')
    ...
    parser.add_argument('--test_epoch', type=int, default=100,
                        help='The epoch number for starting to test.')
    ...
    parser.add_argument('--interaction', nargs='?', default='plus',
