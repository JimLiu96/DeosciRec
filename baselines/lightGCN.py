...
python lightGCN.py --regs [1e-5] --embed_size 64  --lr 0.001 --save_flag 1 --pretrain 0 --batch_size 1024 --epoch 800 --verbose 1 --layer_size [64,64,64] --node_dropout [0.1]*3 --mess_dropout [0.1]*3 --gpu 2 --adj_type laplacian --alg_type lightgcn

# python lightgcn.py --regs [1e-5] --embed_size 64 --layer_size [64,64,64] --lr 0.001 --save_flag 1 --pretrain 0 --batch_size 1024 --epoch 400 --verbose 1 


nohup python lightGCN.py --dataset gowalla  --regs [1e-4] --embed_size 64 --lr 0.001 --save_flag 1 --pretrain 0 --batch_size 1024 --epoch 100 --verbose 1 --layer_size [64,64,64] --adj_type laplacian --alg_type lightgcn --gpu_id 1 > gowalla-lap-lightgcn-3l-202008110211.out&


Created on Oct 10, 2018
Tensorflow Implementation of Neural Graph Collaborative Filtering (NGCF) model in:
Wang Xiang et al. Neural Graph Collaborative Filtering. In SIGIR 2019.
ml100k ml1m ratings_Amazon_Instant_Video ratings_ml-1m
python lightGCN.py --dataset douban --regs [1e-5] --embed_size 64 --lr 0.0001 --save_flag 1 --pretrain 0 --batch_size 1024 --epoch 400 --verbose 1 --layer_size [64]*15
python lightGCN.py --dataset ratings_Amazon_Instant_Video --regs [1e-5] --embed_size 64 --layer_size [64] --lr 0.0001 --save_flag 1 --pretrain 0 --batch_size 1024 --epoch 400 --verbose 1
python lightGCN.py --dataset ratings_ml-1m --regs [1e-5] --embed_size 64 --lr 0.0001 --save_flag 1 --pretrain 0 --batch_size 1024 --epoch 400 --verbose 1 --layer_size [64]*2
python lightGCN.py --dataset ml100k --regs [1e-5] --embed_size 64 --lr 0.0001 --save_flag 1 --pretrain 0 --batch_size 1024 --epoch 400 --verbose 1  --layer_size [64]*3
python lightGCN.py --dataset douban --regs [1e-5] --embed_size 64 --layer_size [64]*4 --lr 0.0001 --save_flag 1 --pretrain 0 --batch_size 1024 --epoch 400 --verbose 1 
python lightGCN.py --dataset douban --regs [1e-5] --embed_size 64 --layer_size [64]*5 --lr 0.0001 --save_flag 1 --pretrain 0 --batch_size 1024 --epoch 400 --verbose 1 
python lightGCN.py --dataset douban --regs [1e-5] --embed_size 64 --layer_size [64]*6 --lr 0.0001 --save_flag 1 --pretrain 0 --batch_size 1024 --epoch 400 --verbose 1 
python lightGCN.py --dataset douban --regs [1e-5] --embed_size 64 --layer_size [64]*7 --lr 0.0001 --save_flag 1 --pretrain 0 --batch_size 1024 --epoch 400 --verbose 1 
python lightGCN.py --dataset douban --regs [1e-5] --embed_size 64 --layer_size [64]*8 --lr 0.0001 --save_flag 1 --pretrain 0 --batch_size 1024 --epoch 400 --verbose 1 
python lightGCN.py --dataset douban --regs [1e-5] --embed_size 64 --layer_size [64]*9 --lr 0.0001 --save_flag 1 --pretrain 0 --batch_size 1024 --epoch 400 --verbose 1 
python lightGCN.py --dataset douban --regs [1e-5] --embed_size 64 --layer_size [64]*10 --lr 0.0001 --save_flag 1 --pretrain 0 --batch_size 1024 --epoch 400 --verbose 1 
python lightGCN.py --dataset douban --regs [1e-5] --embed_size 64 --layer_size [64]*11 --lr 0.0001 --save_flag 1 --pretrain 0 --batch_size 1024 --epoch 400 --verbose 1 
python lightGCN.py --dataset douban --regs [1e-5] --embed_size 64 --layer_size [64]*12 --lr 0.0001 --save_flag 1 --pretrain 0 --batch_size 1024 --epoch 400 --verbose 1 
python lightGCN.py --dataset douban --regs [1e-5] --embed_size 64 --layer_size [64]*13 --lr 0.0001 --save_flag 1 --pretrain 0 --batch_size 1024 --epoch 400 --verbose 1 
python lightGCN.py --dataset douban --regs [1e-5] --embed_size 64 --layer_size [64]*14 --lr 0.0001 --save_flag 1 --pretrain 0 --batch_size 1024 --epoch 400 --verbose 1 
python lightGCN.py --dataset ratings_ml-1m --regs [1e-5] --embed_size 64  --lr 0.001 --save_flag 1 --pretrain 0 --batch_size 1024 --epoch 300 --verbose 1 --layer_size [64]*2 --node_dropout [0]*12 --mess_dropout [0]*12
python lightGCN.py --dataset Movies_and_TV --regs [1e-5] --embed_size 64  --lr 0.0001 --save_flag 1 --pretrain 0 --batch_size 1024 --epoch 400 --verbose 1 --layer_size [64, 64, 64]
python lightGCN.py --dataset gowalla --regs [1e-4] --embed_size 64  --lr 0.001 --save_flag 1 --pretrain 0 --batch_size 1024 --epoch 1000 --verbose 1 --layer_size [64,64,64]

@author: Xiang Wang (xiangwangus.edu)
'''
...
class LightGCN(object):
    ...
    # implemented single layer gcn
    def _create_gcn_single_embed(self):
...
if __name__ == '__main__':
    ...
    *********************************************************
    ...
    for epoch in range(args.epoch):
        ...
        if args.verbose > 0:
            perf_str = 'Validation -- Epoch %d [%.1fs + %.1fs]: train==[%.5f=%.5f + %.5f + %.5f], recall=[%.5f, %.5f], ' \
    ...
    if ckpt and ckpt.model_checkpoint_path:
        ...
        final_perf = '******* Best validation model recall=[%.5f, %.5f], precision=[%.5f, %.5f], hit=[%.5f, %.5f],' \
                        'ndcg=[%.5f, %.5f]' % \
                        (ret['recall'][0], ret['recall'][-1],
                        ret['precision'][0], ret['precision'][-1],
                        ret['hit_ratio'][0], ret['hit_ratio'][-1],
