...
nohup python BPRMF.py --dataset Movies_and_TV --regs [1e-5] --embed_size 64 --layer_size [64,64,64] --lr 0.0001 --save_flag 1 --pretrain 0 --batch_size 1024 --epoch 400 --verbose 1 --node_dropout [0.1] --mess_dropout [0.1,0.1,0.1]
nohup python BPRMF.py --dataset gowalla --regs [1e-5] --embed_size 64 --layer_size [64,64,64] --lr 0.0001 --save_flag 1 --pretrain 0 --batch_size 1024 --epoch 400 --verbose 1 --node_dropout [0.1] --mess_dropout [0.1,0.1,0.1] > gowalla/bprmf_v1.out&
...
if __name__ == '__main__':
    ...
    if args.pretrain == 1:
        ...
        if ckpt and ckpt.model_checkpoint_path:
            ...
            ret = test(sess, model, users_to_test, is_valid=False, drop_flag=False)
    ...
    for epoch in range(args.epoch):
        ...
        ret = test(sess, model, users_to_test, is_valid=True, drop_flag=False)
    ...
    if ckpt and ckpt.model_checkpoint_path:
        sess.run(tf.global_variables_initializer())
        saver.restore(sess, ckpt.model_checkpoint_path)
        print('load the best validation model parameters from: ', weights_save_path)
